...
import { apiLimiter, lookupLimiter } from './middleware/rateLimit.js'
import { payloadErrorHandler } from './middleware/errorHandlers.js'
...
app.use('/api/deal', lookupLimiter, dealRouter)
